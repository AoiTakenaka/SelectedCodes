...
/* harmony import */ var _modules_userAgentChecker__WEBPACK_IMPORTED_MODULE_190__ = __webpack_require__(/*! ./modules/_userAgentChecker */ "./src/js/modules/_userAgentChecker.js");
/* harmony import */ var _modules_ThreeCanvas__WEBPACK_IMPORTED_MODULE_191__ = __webpack_require__(/*! ./modules/_ThreeCanvas */ "./src/js/modules/_ThreeCanvas.js");
...
/* harmony import */ var _modules_modalPopup__WEBPACK_IMPORTED_MODULE_193__ = __webpack_require__(/*! ./modules/_modalPopup */ "./src/js/modules/_modalPopup.js");
...
(0,_modules_userAgentChecker__WEBPACK_IMPORTED_MODULE_190__.default)();

var threeFnc = function threeFnc() {
  var threeCanvas = new _modules_ThreeCanvas__WEBPACK_IMPORTED_MODULE_191__.default();
  threeCanvas.render();
};
...
var modalFnc = function modalFnc() {
  var Modal = new _modules_modalPopup__WEBPACK_IMPORTED_MODULE_193__.default();
...
var roadJsonFunc = function roadJsonFunc(CLASSNAME) {
  var dist = _toConsumableArray(document.querySelectorAll(CLASSNAME));

  if (dist.length === 0) return;
  var filename = CLASSNAME.replace('.js-roadJson-', "");
  var url = "./public/json/".concat(filename, ".json");

  var itemlistDOM = function itemlistDOM(OBJECT) {
    var img = OBJECT.img,
        itmeName = OBJECT.itmeName,
        price = OBJECT.price;
    var li = document.createElement('li'); // prettier-ignore

    var template = "\n          <div class=\"sample-item-image\">\n              <img src=\"".concat(img, "\" alt=\"").concat(itmeName, "\">\n          </div>\n          <div class=\"sample-item-detail\">\n              <h3 class=\"sample-item-name\">").concat(itmeName, "</h3>\n              <p class=\"sample-item-price\">\n                  ").concat(price, "\n              </p>\n          </div>\n    ");
    li.classList.add('sample-item');
    li.innerHTML = template;
    return li;
  };

  var appendDOM = function appendDOM(DOM) {
    dist.forEach(function (DIST) {
      return DIST.appendChild(DOM);
    });
  };
...
/***/ "./src/js/modules/_ThreeCanvas.js":
/*!****************************************!*\
  !*** ./src/js/modules/_ThreeCanvas.js ***!
  \****************************************/
/*! namespace exports */
...
/* harmony export */   "default": function() { return /* binding */ ThreeCanvas; }
/* harmony export */ });
/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/polyfill */ "./node_modules/@babel/polyfill/lib/index.js");
/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! three */ "./node_modules/three/build/three.module.js");
/* harmony import */ var _shaders_vertexShader_vert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shaders/vertexShader.vert */ "./src/js/shaders/vertexShader.vert");
/* harmony import */ var _shaders_vertexShader_vert__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_shaders_vertexShader_vert__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _shaders_fragmentShader_frag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shaders/fragmentShader.frag */ "./src/js/shaders/fragmentShader.frag");
/* harmony import */ var _shaders_fragmentShader_frag__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_shaders_fragmentShader_frag__WEBPACK_IMPORTED_MODULE_2__);
...
var ThreeCanvas = /*#__PURE__*/function () {
  function ThreeCanvas() {
    _classCallCheck(this, ThreeCanvas);

    this.canvas = document.querySelector('#canvas');
    if (!this.canvas) return; // キャンバスサイズ

    this.width = window.innerWidth;
    this.height = window.innerHeight; // レンダー

    this.renderer = new three__WEBPACK_IMPORTED_MODULE_3__.WebGLRenderer({
      canvas: this.canvas
    });
    this.renderer.setPixelRatio(window.devicePixelRatio);
    this.renderer.setSize(this.width, this.height); // シーン

    this.scene = new three__WEBPACK_IMPORTED_MODULE_3__.Scene(); // カメラ

    this.camera = new three__WEBPACK_IMPORTED_MODULE_3__.PerspectiveCamera(45, this.width / this.height);
    this.camera.position.set(0, 0, 1000); // マウス座標

    this.mouse = new three__WEBPACK_IMPORTED_MODULE_3__.Vector2(0.5, 0.5); // ユニフォーム変数
    ...
    this.uniforms = {
      ...
      u_resolution: {
        value: new three__WEBPACK_IMPORTED_MODULE_3__.Vector2(this.width, this.height)
      },
      u_time: {
        value: 0.0
      }
    ...
    var geometry = new three__WEBPACK_IMPORTED_MODULE_3__.BoxGeometry(400, 400, 400);
    var material = new three__WEBPACK_IMPORTED_MODULE_3__.MeshNormalMaterial();
    this.box = new three__WEBPACK_IMPORTED_MODULE_3__.Mesh(geometry, material);
    this.scene.add(this.box); // モデル２：平面

    var geometry2 = new three__WEBPACK_IMPORTED_MODULE_3__.PlaneGeometry(2, 2, 10, 10);
    var material2 = new three__WEBPACK_IMPORTED_MODULE_3__.ShaderMaterial({
      uniforms: this.uniforms,
      vertexShader: (_shaders_vertexShader_vert__WEBPACK_IMPORTED_MODULE_1___default()),
      fragmentShader: (_shaders_fragmentShader_frag__WEBPACK_IMPORTED_MODULE_2___default()) // wireframe: true,

    });
    this.plane = new three__WEBPACK_IMPORTED_MODULE_3__.Mesh(geometry2, material2);
    this.scene.add(this.plane); // 描画ループ開始
...
var ModalPopup = /*#__PURE__*/function () {
  function ModalPopup() {
    ...
    this.html = document.querySelector('html'); // モーダルエリア作成

    this.area = document.createElement('div');
    this.area.setAttribute('id', 'modal-area');
    this.body.appendChild(this.area); // マスク作成
    ...
    this.area.appendChild(this.container); // クローズボタン作成
  ...
  _createClass(ModalPopup, [{
    ...
    value: function init(MODAL, INDEX) {
      ...
      var content = MODAL.querySelector('.modal-content'); // トリガー隣接コンテント非表示・クローン

      content.style.display = 'none';
      var clone = content.cloneNode(true);
      this.container.appendChild(clone); // トリガーの処理
    ...
    value: function closeModal() {
      ...
      _toConsumableArray(contents).forEach(function (cnt) {
        ...
        _this3.html.style.overflow = 'initial';
      });
    }
  }, {
    key: "openModal",
...
var SwitchTab = /*#__PURE__*/function () {
  function SwitchTab(TAB) {
    ...
    this.contents = TAB.querySelector('.js-tab-contents'); // コンテント部の処理
...
/***/ "./src/js/shaders/fragmentShader.frag":
/*!********************************************!*\
  !*** ./src/js/shaders/fragmentShader.frag ***!
  \********************************************/
...
/******/ })()
;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,